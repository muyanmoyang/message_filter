...
public class Sort_IG {
	/**
	 * 对 IG值进行降序排列 ， 根据IG值大小进行特征词选择,分别取400、500、600、700、800 个进行对比实验
	 * @param args
	 * @throws IOException 
	 */
	public static void main(String[] args) throws IOException {
		Map<String,Double> IgMap = getMapOfIG("C:/Users/Administrator/Desktop/论文(改小后的数据集)/IGOfWords.txt") ;
		Map<String,Double> sortIgMap = sortIG(IgMap ,"C:/Users/Administrator/Desktop/论文(改小后的数据集)/IG值排序.txt") ;
		int IGthreshold = 800 ;
		featureSelectOfWords("C:/Users/Administrator/Desktop/论文(改小后的数据集)/IG值排序.txt", 
							"C:/Users/Administrator/Desktop/论文(改小后的数据集)/" + IGthreshold + "特征词/" + "特征词选择_" + IGthreshold + ".txt",IGthreshold);
	}
