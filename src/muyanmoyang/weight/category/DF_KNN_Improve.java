...
public class DF_KNN_Improve {
	public static Map<Integer,Double> weight() throws IOException{
		int threshold = 100 ; // 特征词个数
		Map<Integer,String> featureWordMap = Weight.loadFeatureWord("C:/Users/Administrator/Desktop/论文(改小后的数据集)/DFofWords.txt") ;
		...
		Map<Integer,Double> weightMap = Weight.computeWeightOfTrain(trainMap, featureWordAndTimeMap, 
									"C:/Users/Administrator/Desktop/论文(改小后的数据集)/DF相似度/文本加权.txt");
		return weightMap ;
	}
...
//		FileWriter writer = new FileWriter(new File("C:/Users/Administrator/Desktop/论文(改小后的数据集)/DF相似度/近邻_" + k + "/改进结果.txt"));
...
//					"C:/Users/Administrator/Desktop/论文(改小后的数据集)/DF相似度/近邻_" + k + "/第" + i +"篇测试文本相似度.txt",weightMap);
...
//			writer.flush();
		...
		// 召回率
		recall = KNN_Classification.computeRecallrate(classLabel,"C:/Users/Administrator/Desktop/论文(改小后的数据集)/DF相似度/近邻_" + k + "/改进结果.txt", testResultMap);
		
		// 准确率
		precision = KNN_Classification.computePrecision(classLabel,"C:/Users/Administrator/Desktop/论文(改小后的数据集)/DF相似度/近邻_" + k + "/改进结果.txt", testResultMap);
