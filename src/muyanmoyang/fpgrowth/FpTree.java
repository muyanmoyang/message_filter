...
public class FpTree {
    ...
    public static void main(String[] args) throws IOException{
        ...
        //从文件中读取事物数据集
    	FileWriter writer = new FileWriter(new File("C:/Users/Administrator/Desktop/论文(改小后的数据集)/频繁项集.txt")) ;
        String file = "C:/Users/Administrator/Desktop/论文(改小后的数据集)/textWithWordNum.txt";
